...
CXXFLAGS='-arch x86_64 -I/usr/local/Cellar/gcc\@6/6.5.0/include/c++/6.5.0/ -I$PREFIX/include -fwrapv -fno-strict-aliasing -Werror -g -Wl,-undefined -Wl,dynamic_lookup -fno-extern-tls-init' \
